            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel-content">
                        <h4>3. Your order summary</h4>
                        <a class="des" href="">Review your order summary below</a><br>
                        ...
                        <br>
                        <a class="des" href="">By publishing my order, I agree to Grabr’s Terms of Use. I understand that if the product price is incorrect, my order may be canceled.</a><br>
                    </div>
