...
<body style="background-color: #f2f2f2;">
    ...
    <div class="content" style="margin-top:15px">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h4>2. Confirm Delivery City and Date</h4>
                    <a class="des" href="">A TradeZ traveler going to your city will deliver your order. Enter the country your order is coming from and which city you want it to be delivered to.</a><br>
                    <a href="">Route</a><br>
                    <input class="ip_input" type="text" value="Delivery from     United State of America">
                    <input class="ip_input" type="text" value="Delivery to   Ho Chi Minh City "><br>
                    <a href="">How long are you willing to waits?</a><br>

                    <a class="des" href="">The longer period you are ready to wait the more offers you receive and can choose from.</a><br>
                    <div class="long">
                        <a href="">Up to 45 days</a><br>
                        <a class="recommend">Recommend</a>
                        <a class="des" href="">By December 24</a>
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="panel-top" style="margin-top:15px">
                        ...
                        <a class="title" href="">Delivery happens within 1-3 weeks.</a>
                        <input type="text " value="">
                        <a class="title" href="">Your payment is protected by TradeZ and only released to the traveler after you confirm you have recieved your product</a>
                        <input type="text " value="">
                        <a class="title" href="">You’ll coordinate with your traveler a convenient time and public place to pick up your order.</a>
