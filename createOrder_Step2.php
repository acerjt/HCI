...
<body style="background-color: #f2f2f2;">
    ...
    <div class="content" style="margin-top:15px">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h3 style="font-weight:bold">2. Confirm Delivery City and Date</h3>
                    <div class="des">A TradeZ traveler going to your city will deliver your order. Enter the country your order is coming from and which city you want it to be delivered to.</div>
                    <div>Route</div>
                    <div class="ip_input" style="display: flex">
                    ...
                    <div>How long are you willing to waits?</div>

                    <div class="des">The longer period you are ready to wait the more offers you receive and can choose from.</div>
                    <div class="long">
                        <div>Up to 45 days</div>
                        <div class="recommend">Recommend <span class="des">By December 24</span></div>
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="panel-top" style="margin-bottom:15px">
                        ...
                        <span class="title" href="">Delivery happens within 1-3 weeks.</span>
                        <hr>
                        <div class="title">Your payment is protected by TradeZ and only released to the traveler after you confirm you have recieved your product</div>
                        <hr>
                        <div class="title">You’ll coordinate with your traveler a convenient time and public place to pick up your order.</div>
