                ...
                <div class="root">
                    <div class="container">
                        <ul class="progressbar" style="margin-left: -30px">
                            ...
                            <li class="active">Offer received</li>
                            <li class="active">Verify number</li>
                            <li class="fly">Offer choosen</li>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel-content">
                        ...
                        <div>
                            <a style="color: #4c9fbf;" href="">

                                Learn about payment opstions
                            </a>
                        </div>
                        <div style="border: 1px solid #e0e0e0; padding: 10px 16px">
                            ...
                            <div>Enter name as appears on your card</div>
                            <div>
                ...
                <div class="col-md-4 ">
                    <div class="panel-top" style="margin-bottom: 15px">
                        ...
                        <div style="color: #828282; font-size: 15px">
                            Get the item you ordered or get your money back
                        </div>
                    </div>
                    <div class="panel-bottom " style="margin-bottom:15px ">
                        <div>Things keep in mind</div>
                        <hr>
                        <div style="font-size: 15px;color: #4c9fbf;">
                            <div style="color: inherit"><a style="color: inherit;font-size: 15px;" href="">Can I pay in installments?</a></div>
                            <div style="color: inherit"><a style="color: inherit;font-size: 15px;" href="">What methods of payment does TradeZ accept?</a></div>
                            <div style="color: inherit"><a style="color: inherit;font-size: 15px;" href="">Can I cancel my order or return my item?</a></div>
                            <div style="color: inherit"><a style="color: inherit;font-size: 15px;" href="">More about how TradeZ work?</a></div>
                        </div>
                    </div>
