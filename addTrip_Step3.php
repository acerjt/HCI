...
<body style="background-color: #f2f2f2;">
                ...
                <div class="root">
                    <div class="container">
                        <ul class="progressbar" >
                            <li class="fly">Verify phone number</li>
                            <li class="">Payout method</li>
                            <li class="">Verify complete</li>
    ...
    <div class="container">
        <div class="main-panel" style="background-color: #fff; margin: 24px 0px">
            <div>
                <h3 style="font-weight: 500">Verify your phone number</h3>
                <div style="color: #828282;">Please take a moment to verify your phone number. This helps us secure your account.</div>
                <div>
                    <input class="ip_input1" type="text" placeholder="+XX XXX XXX XXX">
                </div>
                <div style="display: flex; margin: 24px 0px">
                    <div style="width:50%;">
                        <a style="width: 95%;height:40px"  class="btn btn-accept" role="button " href="?page=addTrip_Step4"><i class="far fa-envelope fa-lg"></i> Send Message</a>
                    </div>
                    <div style="width: 50%;float:right">
                        <a  style="width: 95%; float:right; height:40px"  class="btn btn-send-message" role="button " href="?page=addTrip_Step4"><i class="fas fa-microphone"></i> Voice Call</a>
                    </div>
                </div>
                <div style="color: #828282;">
                    Enter your phone number in international format, including country code. Ex. fo the US: +1 XXX XXX XXXX.
                </div>
            </div>
        </div>
    </div>
