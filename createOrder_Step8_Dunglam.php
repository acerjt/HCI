            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel-content">
                        ...
                        <a class="des" href="">Add a order and let traveler bring. <br>
                        Make a request offer.</a><br>
                        <div class="buttons">
                            <a class="btn btn-primary " role="button " href="# " style="background-color:#4c9fbf; color:#fff;">Continue</a>
                        </div>
                    </div>
