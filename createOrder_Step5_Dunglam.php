                    ...
                    <div class="root">
                        <div class="container">
                            <ul class="progressbar">
                                ...
                                <li style="color:#bdbdbd">Offer received</li>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel-content">
                        <h4>Awaiting offers</h4>

                        <img class="product_image" src="img/images/im_iphone11_ebay.png" alt="">

                        <a class="name" href="">Buy Simple Mobie - Apple iPhone 11 Pro (64KB) - Space Gray from Amazon.s</a>
                        <br>
                        <input class="line" type="text " value="">
                        <br>
                        <a style="color:#4c9fbf" href="">Offer details</a>
                        <img src="img/icon/ic_down.png" alt=""><br>
                    </div>
                    <a style="color:#828282; font-size:18px; padding-left: 15px;" href="">CHOOSE OFFER</a>


                    <div class="panel-request-delivery">
                        <a style="font-size: 20px; color: black;font-weight: bold;" href="">Request delivery</a><br>
                        <a class="des" href="">The traveler below have trips planned .... Give them a direct delivery request to get yours.</a><br>
                        <div class="request">
                            <img class="rounded-circle " src="img/avatar/av_1.jpg ">
                            <a href=" " class="name">Tung Nguyen</a>
                            <a href=" " class="time ">11 minutes ago</a>
                            ...
                            <br><br>
                            <a class="des" href="">Traveler Rating.</a>
                            <div class="buttons">
                                <a class="btn btn-primary " role="button " href="# " style="background-color:#e5f3ff; border:1px solid #e5f3ff;padding:3px 7px;">PENDING</a>
                            </div>
                            <input class="line" type="text " value="">
                            <br>
                            <img src="img/icon/ic_calender.png" alt="">
                            <a href="" style="color:#828282;">Delivery date</a>
                            <a href="">December 23, 2019 from United State, America</a>
                            <input class="line" type="text " value="">
                            <br>
                            <a href="" style="color:#4c9fbf;">Total $ 451</a>
                            <a href="">Price summary</a><br>
                            <div class="panel">
                            ...
                            <a href="">Estimated total</a>
                            <a href="" style="font-weight: bold;">$ 450.2</a> <br>
                            <a class="des" href="">We will processed to payment page.</a><br>
                            <div class="buttons">
                                <a class="btn btn-primary " role="button " href="# ">Send Message</a>
                            </div>
                            <div class="buttons">
                                <a class="btn btn-primary " role="button " href="# " style="background-color:#4c9fbf; color:#fff;">Accept Offer</a>
                            </div>
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="panel-bottom " style="margin-top:15px ">
                        ...
                        <br><br>
                        <a class="title " href=" "><span style="color:green; font-weight:bold; ">59 verfied travelers</span> are ready to deliver your item to Ho Chi Minh City, VN!</a>
