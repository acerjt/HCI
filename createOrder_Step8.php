                ...
                <div class="root">
                    <div class="container">
                        <ul class="progressbar" style="margin-left: -30px">
                            ...
                            <li class="active">Offer choosen</li>

                            <li class="fly">Delivery started</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container big-container">
        <div class="main-panel-container">
            ...
            <div class="main-panel" style="background-color: #fff; margin: 24px 0px">
                ...
                <div>
                    <h3 style="font-weight: bold">You are all set!</h3>
                    <div style="margin-bottom: 16px">

                        <div style="color: #828282;">- Create an order for a product you want and include details.</div>
                        <div style="color: #828282;">- A traveler can buy any item from around the world and get it to you.</div>
                    </div>
