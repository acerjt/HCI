        ...
        <div class="main-panel" style="background-color: #fff; margin: 24px 0px">
            <div>
                ...
                <div style="display: flex; margin: 24px 0px">
                    <div style="width:50%;">
                        <a style="width: 95%;height:40px"  class="btn btn-accept" role="button " href="# "><i class="far fa-envelope fa-lg"></i> Send Message</a>
                    </div>
                    <div style="width: 50%;float:right">
                        <a  style="width: 95%; float:right; height:40px"  class="btn btn-send-message" role="button " href="# "><i class="fas fa-microphone"></i> Voice Call</a>
                    </div>
                </div>
