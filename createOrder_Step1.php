        ...
        <div class="container ">
            <div class="row ">
                <div class="col-md-8 ">
                    ...
                    <input class="ip_input " style="margin-bottom:15px; height:100px; text-align: top; " type="text " value="Enter product details like size, color, model, etc... ">
                    <br>
                    <a href=" ">Price on www.amabuy.com</a><br>
