...
<head>
    ...
    <style>
        ...
        .footer-dark ul li a:hover {
            color: #3f89a8 !important;
            text-decoration-style: solid !important;
            border-bottom: 1px solid #3f89a8;
        }
        ...
        @media (min-width: 576px) {
            ...
            body > div.footer-dark > footer > div > div.align-items-center.footer-contact > div.footer-contact-logo > a {
            padding: 0px 23px;
        }
        }
    ...
    <div class="footer-dark">
        ...
        <footer>
            <div class="container">
                ...
                <div class="footer-content" style="display: flex;font-family:Graphik, 'Graphik LC Web', 'Helvetica Neue', Arial, sans-serif;
font-size:16px;line-height:24px;text-decoration-style:solid;font-weight:400 !important;">

                    <div class="footer-div-item" style="width:300px;">
                        <img style="height:auto" class="image_logo" src="img/icon/ic_logo.png" alt="">
                    </div>
                ...
                <div style="display: flex" class="align-items-center footer-contact">
                    ...
                    <div>
                        ...
                        <a href="#"><img class="get-app" src="img/images/im_store.png"></a>
                    </div>
