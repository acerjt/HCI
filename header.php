...
and bootstrap studio can't select them */
    ...
    <style>
        ...
        .header-blue .navbar .navbar-collapse span .signup {
            color: #000;
            text-decoration: none;
        }
        
        .header-blue .navbar .navbar-collapse span .signup:hover {
            color: #4c9fbf;
        }
        
        .header-blue .navbar .navbar-collapse span .travel {
            color: #000;
            text-decoration: none;
        }
        
        .header-blue .navbar .navbar-collapse span .travel:hover {
            color: #4c9fbf;
        }
        ...
        .header-blue .iphone-mockup .screen {
            ...
            overflow: hidden;
            background: url(blob:https://bootstrapstudio.io/e446fad8-94bd-4638-8d1b-6fc76ede8bcb);
        ...
        <div class="header-blue">
            <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
                <div class="container-fluid">
                    ...
                    <span class="plane-icon" style="color:black">
                            <i class="fas fa-plane fa-lg"></i>
                            </span>

                    <span class="order-icon"><img src="img/icon/ic.png" width="25px" height="25px" alt=""></span>
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        ...
                        <form class="form-inline mr-auto" target="_self">
                            <div class="form-group"><label for="search-field"></label>
                                <a class="form-control search-field" type="search" id="search-field" name="search"></a>
                            </div>
                        </form>
                        <div class="navbar-group">
                            <span class="navbar-text mr-4"> <a class="travel" href="#"><i class="fas fa-plane fa-lg"></i> Make money traveling</a></span>

                            <span class="navbar-text mr-4"> <a class="signup" href="#">Sign up</a></span>
                            <span class="navbar-text mr-4"> <a class="login" href="#">Log in</a></span>
                            <a class="btn btn-light action-button" href="#">Create order</a>
                        </div>
