    ...
    <div>
        <div class="header-blue">
            <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
                <div class="container-fluid"><a class="navbar-brand" href="#"><img class="header-logo"
                            src="Free_Sample_By_Wix.png" alt=""></a><button data-toggle="collapse"
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        ...
                        <div class="navbar-group">
                            <span class="navbar-text mr-4"> <a class="signup" href="#"><i class="fas fa-plane fa-2x "></i> Make money traveling</a></span>
